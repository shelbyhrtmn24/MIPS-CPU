...
## Overview 
This repository provides an automated, local way to test the processor against various assembly files.
...
## Output
The autotester will generate an HTML report to the `html_reports` directory. This file will automatically open in your default browser. Each block in the HTML report represents a single test case and will show the following information:
