module processor(
    ...
    assign sign_extended_immed[31:17] = DX_IR_out[16] ? 15'b111111111111111 : 15'b0;  
    ...
    assign i_not_branch = (!global_opcode[4] & !global_opcode[3] & global_opcode[2] & global_opcode[0]) | 
        (!global_opcode[4] & global_opcode[3] & !global_opcode[2] & !global_opcode[1] & !global_opcode[0]);
    ...
    //PC Controls - Branches and Jumps
    wire [31:0] ctrl_PC;
